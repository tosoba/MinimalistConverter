...
void initDependencyContainer() {
  dependencies.KiwiContainer()
    ...
    ..registerFactory(
      (container) => ConverterRepository(
        container.resolve(),
        container.resolve(),
      ),
    )
    ..registerSingleton(
      (container) => ConverterBloc(
        container.resolve(),
    ...
    ..registerSingleton(
      (container) => CurrencyDisplayBloc(
        container.resolve<CurrencyDisplayState>("initial_red_display_state"),
        container.resolve<Stream<CurrencyDisplayEvent>>("red_display_events"),
      ),
